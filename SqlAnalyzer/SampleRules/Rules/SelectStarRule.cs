...
namespace SampleRules.Rules
{
    [LocalizedExportCodeAnalysisRule(RuleId,
        ...
        RuleConstants.SelectStarRule_RuleName,
        RuleConstants.SelectStarRule_ProblemDescription,
        Category = RuleConstants.CategoryPerformance,
        RuleScope = SqlRuleScope.Element)]
    public sealed class SelectStarRule
        : BaseSqlCodeAnalysisRule<SelectStarVisitor, SelectStatement>
    {
        /// <summary>  
        ...
        /// </summary>  
        public const string RuleId = "RuleSamples.SR1009";

        public SelectStarRule()
        {

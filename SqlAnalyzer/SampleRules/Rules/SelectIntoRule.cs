...
namespace SampleRules.Rules
{
    [LocalizedExportCodeAnalysisRule(RuleId,
        ...
        RuleConstants.SelectIntoRule_RuleName,
        RuleConstants.SelectIntoRule_ProblemDescription,
        Category = RuleConstants.CategoryPerformance,
        RuleScope = SqlRuleScope.Element)]
    public sealed class SelectIntoRule
        : BaseSqlCodeAnalysisRule<SelectIntoVisitor, SelectStatement>
    {
        /// <summary>  
        ...
        /// </summary>  
        public const string RuleId = "RuleSamples.SR1007";

        public SelectIntoRule()
        {

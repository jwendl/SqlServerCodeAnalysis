...
namespace SampleRules.Rules
{
    [LocalizedExportCodeAnalysisRule(RuleId,
        ...
        RuleConstants.SelectLikeWildcardRule_RuleName,
        RuleConstants.SelectLikeWildcardRule_ProblemDescription,
        Category = RuleConstants.CategoryPerformance,
        RuleScope = SqlRuleScope.Element)]
    public sealed class SelectLikeWildcardRule
        : BaseSqlCodeAnalysisRule<SelectLikeWildcardVisitor, SelectStatement>
    {
        /// <summary>  
        ...
        /// </summary>  
        public const string RuleId = "RuleSamples.SR1008";

        public SelectLikeWildcardRule()
        {

...
namespace SampleRules.Rules
{
    [LocalizedExportCodeAnalysisRule(RuleId,
        ...
        RuleConstants.DeleteWithNoPredicateRule_RuleName,
        RuleConstants.DeleteWithNoPredicateRule_ProblemDescription,
        Category = RuleConstants.CategoryPerformance,
        RuleScope = SqlRuleScope.Element)]
    public sealed class DeleteWithNoPredicateRule
        : BaseSqlCodeAnalysisRule<DeleteWithNoPredicateVisitor, DeleteStatement>
    {
        /// <summary>  
        ...
        /// </summary>  
        public const string RuleId = "RuleSamples.SR1006";

        public DeleteWithNoPredicateRule()
        {
